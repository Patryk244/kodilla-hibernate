...
class TaskDaoTestSuite {
    ...
    private static final String TODO = "New task to do";
    ...
    void testNamedQueries() {
        ...
        System.out.println("durationLongerThanTasks: " + durationLongerThanTasks.size());
        try {
            assertEquals(2, longTasks.size());
            assertEquals(3, shortTasks.size());
            assertEquals(0, enoughTimeTasks.size());
